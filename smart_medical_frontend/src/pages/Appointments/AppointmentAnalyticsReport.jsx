...
const AppointmentAnalyticsReportPage = () => {
    ...
    const isAdmin = userData?.user_type === 'patient';
    ...
    const getFilteredAppointments = () => {
        return appointments.filter(appointment => {
            ...
            if (filters.hospitalName !== 'all' && appointment.hospital?.name !== filters.hospitalName) return false;
    ...
    const calculateStats = () => {
        ...
        if (filteredAppointments.length > 0) {
            ...
            // Doctor diversity
            const uniqueDoctors = new Set(filteredAppointments.map(a => a.doctor?.user?.id).filter(Boolean));
            stats.totalDoctors = uniqueDoctors.size;

            // Completion rate
            stats.completionRate = (stats.completedAppointments / stats.totalAppointments) * 100;
            ...
            const topSpecialtyEntry = Object.entries(specialties).sort((a, b) => b[1] - a[1])[0];
            if (topSpecialtyEntry) {
                stats.topSpecialty = topSpecialtyEntry[0];
                stats.topSpecialtyCount = topSpecialtyEntry[1];
            }
        }
    ...
    const getUniqueHospitals = () => {
        const hospitals = [...new Set(appointments.map(a => a.hospital?.name).filter(Boolean))];
    ...
    const hasActiveFilters = () => {
        return filters.status !== 'all' || filters.doctorSpecialty !== 'all' ||
            filters.hospitalName !== 'all' || filters.appointmentDateFrom ||
                        ...
                        <table class="table">
                            ...
                            <tbody>
                                ${filteredAppointments.map(appointment => `
                                    <tr>
                                        <td>${appointment.patient?.first_name || ''} ${appointment.patient?.last_name || 'Unknown Patient'}</td>
        ...
        <div className="min-h-screen bg-white">
            ...
            <div className="max-w-7xl mx-auto px-6 py-6">
                ...
                <div className="bg-gray-50 border-2 border-black p-6">
                        ...
                        <div className="bg-white border border-black p-4">
                            ...
                            <div className="space-y-2 text-sm text-black">
                                ...
                                <div className="flex justify-between">
                                    ...
                                    <span className="font-bold text-purple-600">{stats.totalHospitals}</span>
                                </div>
                                <div className="flex justify-between">
                                    <span>Top Specialty:</span>
                                    <span className="font-bold text-green-600">{stats.topSpecialty || 'N/A'}</span>
                                </div>
                                <div className="flex justify-between">
                    ...
                    <div className="bg-white border border-black p-4 mb-6">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                            <div className="text-center">
                                ...
                                <div className="text-sm text-black uppercase font-bold">Completion Rate</div>
                            </div>
                            <div className="text-center">
                                <div className="text-2xl font-bold text-blue-600 mb-1">
                                    {stats.totalDoctors}
                                </div>
                                <div className="text-sm text-black uppercase font-bold">Active Doctors</div>
                            </div>
                            <div className="text-center">
                                <div className="text-2xl font-bold text-purple-600 mb-1">
                                    {stats.totalHospitals}
                                </div>
                                <div className="text-sm text-black uppercase font-bold">Partner Hospitals</div>
                            </div>
                        </div>
                    </div>
                    ...
                    {/* Monthly Trends */}
                    <div className="bg-white border border-black p-4 mb-6">
                        <h4 className="font-bold text-black mb-4 uppercase">Monthly Performance</h4>
                        <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                            ...
                            <div className="text-center">
                                ...
                                <div className="text-sm text-black uppercase font-bold">This Year</div>
                            </div>
                            <div className="text-center">
