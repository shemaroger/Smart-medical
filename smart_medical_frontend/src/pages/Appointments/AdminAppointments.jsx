...
const AdminAppointments = () => {
    ...
    const handleCreatePrescription = (appointment) => {
        const prescriptionUrl = `/dashboard/prescriptions/create?appointment=${appointment.id}`;
            ...
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between">
                <div>
                    ...
                    <p className="text-sm text-gray-600 mt-1">
                        Manage all system appointments and update their status
                    </p>
                </div>
                        ...
                        <div className="p-6">
                            <div className="mb-4">
                                <p className="text-sm text-gray-600">
                                    Patient: <span className="font-medium">{selectedAppointment.patient?.user?.first_name} {selectedAppointment.patient?.user?.last_name}</span>
                                </p>
                                <p className="text-sm text-gray-600">
                                    Doctor: <span className="font-medium">Dr. {selectedAppointment.doctor?.user?.first_name} {selectedAppointment.doctor?.user?.last_name}</span>
                                </p>
                                <p className="text-sm text-gray-600">
                                    Date: <span className="font-medium">{formatDateTime(selectedAppointment.appointment_date)}</span>
                                </p>
                            </div>
                ...
                <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-50">
                    <div className="bg-white rounded-xl max-w-4xl w-full max-h-[90vh] overflow-y-auto">
                        ...
                        <div className="p-6 space-y-6">
                            {/* Status Banner */}
                            <div className={`p-4 rounded-lg ${statusConfig[selectedAppointment.status].bgColor}`}>
                                <div className="flex items-center justify-between">
                                    <div className="flex items-center">
                                        {React.createElement(statusConfig[selectedAppointment.status].icon, {
                                            className: `w-5 h-5 mr-2 text-${statusConfig[selectedAppointment.status].color}-600`
                                        })}
                                        <span className={`font-medium ${statusConfig[selectedAppointment.status].textColor}`}>
                                ...
                                <div>
                                    ...
                                    <div className="space-y-2">
                                        ...
                                        <div className="flex items-center text-sm">
                                            ...
                                            <span>Status: {statusConfig[selectedAppointment.status].label}</span>
                                        </div>
                                    </div>
                                </div>
